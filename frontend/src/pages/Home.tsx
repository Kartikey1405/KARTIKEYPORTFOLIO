...
//       {/* <Dodecahedron mouseX={mousePos.x} mouseY={mousePos.y} /> */}
//       <Dodecahedron />
...
//             <h1 className="text-5xl md:text-7xl font-display font-bold mb-4 text-glow-cyan">
...
//             <h2 className="text-3xl md:text-5xl font-display font-bold text-white tracking-tight uppercase">
//               KARTIKEY KUSHAGRA
//             </h2>
//           </motion.div>
